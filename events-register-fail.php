          ...
          <div class="row justify-content-center">
            <div class="col-lg-11 col-xl-9">
              <section class="py-4 py-lg-5">
                <h1 class="display-4 mb-3">Команда не зарегистрирована!</h1>
                <p class="lead">
                  В составе должно быть не меньше 3 игроков!
                </p>
                <p class="lead">
                  <a href="events-register-team.php?event_id=<?php echo $event['id'] ?>">Вернуться на страницу регистрации</a>
                </p>
              </section>
            </div>
          </div>
